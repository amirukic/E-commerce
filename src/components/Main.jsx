  ...
  return (
    <main>
      ...
      <aside className="image-text">
        ...
        <p>These low-profile sneakers are your perfect casualwear companion.Featuring a durable rubber outer sole, they'll withstand everything the weather can offer. </p>
        <h2>$125.00    <p>50%</p></h2>
        <p>$250.00</p>
